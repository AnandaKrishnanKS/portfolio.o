      ...
      <AnimatePresence>
        {isScrolled && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 20 }}
            className="md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 z-40 max-w-sm w-[90%] glass-panel rounded-full shadow-2xl p-1.5 flex items-center justify-between border-white/10"
          >
